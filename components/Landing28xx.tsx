    ...
    return (
        <div className="relative bg-brand-black">
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 container mx-auto px-8 md:px-12 text-center max-w-4xl">
                    ...
                    <div className="mb-4 md:mb-8 flex justify-center">
                        <img src="/assets/2800-graphic.svg" alt="2800" className="w-48 md:w-96 opacity-90" />
                    </div>
                    ...
                    <h1 className="font-serif text-3xl sm:text-4xl md:text-7xl leading-tight mb-8 animate-fade-in-up">
                    ...
                    <p className="text-lg md:text-2xl text-brand-cream/80 mb-8">
                        Van brainstorm tot afwerking, van concept tot content.<br className="hidden md:block" />
            ...
            <section className="py-32 bg-brand-black">
                <div className="container mx-auto px-8 md:px-12">
                    <div className="text-center mb-20">
                        ...
                        <h2 className="font-serif text-3xl md:text-6xl italic">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
                        ...
                        <div>
                            ...
                            <p className="text-brand-cream/70 mb-4">
                                Je standards zijn te hoog om te settlen for content die je zelf maakt.
            ...
            <section id="bewijs" className="py-32 bg-brand-black">
                <div className="container mx-auto px-8 md:px-12">
                    <div className="text-center mb-12 max-w-4xl mx-auto">
                        ...
                        <h2 className="font-serif text-3xl md:text-6xl italic mb-6 text-brand-cream px-4">
                ...
                <div className="container mx-auto px-8 md:px-12">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
                        <div>
                            ...
                            <h2 className="font-serif text-3xl md:text-6xl italic mb-8">
                                Gevestigd in <span className="text-brand-green">Hazewinkel</span>
                            </h2>
                            <p className="text-brand-cream/80 text-lg mb-6">
                                10 jaar heb ik gefilmd for agencies. Nu werk ik lokaal,
                                rechtstreeks met bedrijven in de buurt. 28% korting for de
                                28XX regio omdat je in mijn thuisbasis zit.
                            </p>
                            <p className="text-brand-cream/70 mb-8">
                                Geen reiskosten. Snellere turnaround. Bereikbaar for last-minute shoots.
                        ...
                        <div className="relative mt-12 lg:mt-0">
                            <div className="bg-brand-cream rounded-sm p-6 md:p-10 shadow-2xl">
                                <h3 className="font-serif text-2xl md:text-3xl text-brand-black mb-6">
                                    Wat 28% korting<br />
                                    <span className="text-brand-green italic">echt betekent</span>
                                </h3>
                                <div className="space-y-4 text-brand-black/80">
                                    <div className="flex justify-between items-center pb-4 border-b border-brand-black/10 gap-4">
                                        <span className="text-sm md:text-base">Standaard Bedrijfsvideo</span>
                                        <div className="text-right shrink-0">
                                            <div className="line-through text-brand-black/40 text-xs md:text-sm">€2.100</div>
                                            <div className="text-brand-green font-bold text-lg md:text-xl">€1.500*</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-between items-center pb-4 border-b border-brand-black/10 gap-4">
                                        <span className="text-sm md:text-base">Video + Foto Combo</span>
                                        <div className="text-right shrink-0">
                                            <div className="line-through text-brand-black/40 text-xs md:text-sm">€3.200</div>
                                            <div className="text-brand-green font-bold text-lg md:text-xl">€2.300*</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-between items-center pb-4 border-b border-brand-black/10 gap-4">
                                        <span className="text-sm md:text-base">Premium Project</span>
                                        <div className="text-right shrink-0">
                                            <div className="line-through text-brand-black/40 text-xs md:text-sm">€6.000</div>
                                            <div className="text-brand-green font-bold text-lg md:text-xl">€4.300*</div>
                                        </div>
                                    </div>
                                    <div className="flex justify-between items-center pt-2 gap-4">
                                        <span className="text-xs md:text-sm text-brand-black/60">Gemiddelde besparing</span>
                                        <span className="text-brand-green font-bold whitespace-nowrap">€600 - €1.700</span>
                                    </div>
                                    <div className="pt-4 border-t border-brand-black/10">
                                        <p className="text-[10px] md:text-xs text-brand-black/50 italic">
            ...
            <section id="services" className="py-32 bg-brand-cream text-brand-black">
                <div className="container mx-auto px-8 md:px-12">
                    <h2 className="font-serif text-3xl md:text-6xl italic text-center mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        ...
                        <div className="bg-brand-green text-brand-black p-8 rounded-sm text-left">
                            ...
                            <p className="mb-6 text-brand-black/80">
                                Weet je reeds wat je wil? Boek direct een draaidag en claim je 28% korting.
                            </p>
            ...
            <section className="py-20 bg-brand-cream text-brand-black">
                <div className="container mx-auto px-8 md:px-12 text-center">
                    <p className="text-xs md:text-sm tracking-widest uppercase text-brand-black/50 mb-8">Vertrouwd door</p>
                    <div className="grid grid-cols-2 md:flex md:flex-wrap justify-center items-center gap-8 md:gap-12 opacity-60">
                        <div className="flex justify-center"><img src="/assets/logos/NIO_logo.svg.png" alt="NIO" className="h-6 md:h-8 grayscale" /></div>
                        <div className="flex justify-center"><img src="/assets/logos/mechelen.png" alt="Stad Mechelen" className="h-6 md:h-8 grayscale" /></div>
                        <div className="flex justify-center"><img src="/assets/logos/Agentschap inburgering.jpeg" alt="Agentschap Inburgering" className="h-6 md:h-8 grayscale" /></div>
                        <div className="flex justify-center"><img src="/assets/logos/Albert_Heijn_Logo.svg.png" alt="Albert Heijn" className="h-6 md:h-8 grayscale" /></div>
                    </div>
                </div>
            </section>
        </div>
